...
allHrsArray.filter(a => a.className === "image").forEach(e => e.style.border = "2px solid black");
...
document.querySelector(".three").prepend(para2);
...
[...document.querySelector(".archive").children]
.forEach((e, i) => {
  if (i % 2 === 0) e.style.backgroundColor = "aliceblue";
});
...
[...boxSeven.children].forEach(e => e.remove());
...
document.querySelector(".five").append(a1);
document.querySelector(".five").append(a2);